...
def get_filters():
    ...
    while True:
      city = input("\nEnter name of the city for analyze? chicago, new york city or washington\n")
      city = city.lower()
    ...
    while True:
      month = input("\nEnter name of the month to filter dataset? january, february, march, april, may, june or type 'all' to apply no month filter\n")
      month = month.lower()
    ...
    while True:
      day = input("\nEnter name of the day to filter by? monday, tuesday, wednesday, thursday, friday, saturday, sunday or type 'all' to apply no month filter\n")
      day = day.lower()
